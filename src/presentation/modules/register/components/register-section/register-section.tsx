     ...
     <section className="relative min-h-screen flex items-center font-[var(--font-poppins)] text-neutral-900">
      ...
      <div className="max-w-[1324px] h-[869px] items-start mx-auto flex gap-[80px] z-50 justify-between">
        <div className="flex flex-col max-w-[600px] gap-[100px]">
          ...
          <div>
            <h2 className="text-3xl font-bold mt-16">Crie sua conta</h2>
            <h1 className="text-4xl pt-6">Junte-se à Kadoo e transforme sua trajetória educacional!</h1>

            <div className="w-1/2 h-[2px] bg-black my-8 rounded-md" />
            <p className="text-xl mb-6">
              Já conhece a Kadoo?<br />
              Faça parte da nossa comunidade agora mesmo.
            </p>
        ...
        <div className="flex flex-col z-50 w-[609px] h-[auto] bg-white/80 backdrop-blur-md rounded-2xl p-12 shadow-xl border border-white/30 gap-12 mb-auto">
